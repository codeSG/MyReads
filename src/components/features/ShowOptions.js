...
<div className="darkShadow svgContainer showOptions-firstStep" style={{  padding:"2px" , height:"13%" ,}}>
...
<div className="darkShadow svgContainer showOptions-secondStep"  style={{padding:"2px"  }} >
...
backgroundColor: scrollMode ? "white" : "rgba(145, 83, 206, 0.25)"}}  viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...

{
    ...
    <div className="darkShadow svgContainer" style={{padding:"2px" ,  height : "13%"}}>
...
{/*         
        ...
        onClick={()=>goToPage()} /> */}
<svg style={{width:"20px" , height : "20px" , margin:"0" , marginTop:"5px"  , cursor :"pointer" , backgroundColor:"white"}}  onClick={()=>goToPage()  } viewBox="0 0 31 27" fill="none" xmlns="http://www.w3.org/2000/svg">
